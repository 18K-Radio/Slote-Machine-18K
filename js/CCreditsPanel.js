function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 + 390, y: 190};
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("https://www.facebook.com/18KRADIO", "34px " + FONT_GAME, "#000");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("https://www.facebook.com/18KRADIO", "34px " + FONT_GAME, "#fff");
	...
	createjs.Tween.get(_oContainer).to({alpha:1} , 200,createjs.Ease.cubicOut);
    ...
    this._onLogoButRelease = function(){
        window.open("https://www.facebook.com/18KRADIO/","_blank");
    };
